		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comboboxnorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comboboxnorthwind-display": {
								"semanticObject": "comboboxnorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=comboboxnorthwind",
									"url": sap.ui.require.toUrl("comboboxnorthwind")
								}
							}
						}
					}
